...
def warp_image(img, source_prop):
    ...
    '''
    destination_points = np.float32([[0,0],[0,y-1],[x-1,y-1],[x-1,0]])
    ...
    '''
    warped_img = cv2.warpPerspective(img,perspective_transform,(640,480))
    return warped_img
...
class IMGParser:
    def __init__(self):
        ...
        '''
        self.source_prop = np.float32([[0.37,0.55],[0,0.7],[1,0.7],[0.63,0.55]])


        # self.source_prop = np.float32(np.array([[0.45,0.5],[0,0.75],[1,0.75],[0.55,0.5]]))
    ...
    def callback(self, msg):
        ...
        cv2.circle(self.img_bgr,(int(self.source_prop[0][0]*640),int(self.source_prop[0][1]*480)) , 5, (0, 255, 0), -1)
        cv2.circle(self.img_bgr,(int(self.source_prop[1][0]*640),int(self.source_prop[1][1]*480)) , 5, (0, 255, 0), -1)
        cv2.circle(self.img_bgr,(int(self.source_prop[2][0]*640),int(self.source_prop[2][1]*480)) , 5, (0, 255, 0), -1)
        cv2.circle(self.img_bgr,(int(self.source_prop[3][0]*640),int(self.source_prop[3][1]*480)) , 5, (0, 255, 0), -1)
