...
class IMGParser:
    def __init__(self, pkg_name = 'ssafy_3'):
        ...
        self.path_pub = rospy.Publisher('/lane_path', Path, queue_size=5)
        ...
        x = 640
        y = 480
        #self.crop_pts =  np.array([[[0.37*640,0.55*480],[0*640,0.7*480],[1*640,0.7*480],[0.63*640,0.55*480]]],dtype=np.int32)
        ...
        '''
        curve_learner = CURVEFit(order=3, alpha = 10,lane_width= 13,y_margin=1, x_range=30, dx=0.5,min_pts=50)
        '''
        def __init__(
        self,
        order=3,
