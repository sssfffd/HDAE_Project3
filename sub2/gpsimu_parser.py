    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            if self.is_imu==True and self.is_gps == True:
                ...
                os.system('clear')
                print("x : {}".format(self.odom_msg.pose.pose.position.x))
                print("y : {}".format(self.odom_msg.pose.pose.position.y))
                ori_list=[self.odom_msg.pose.pose.orientation.x,self.odom_msg.pose.pose.orientation.y,self.odom_msg.pose.pose.orientation.z,self.odom_msg.pose.pose.orientation.w]
                (roll, pitch, yaw) = euler_from_quaternion (ori_list)
                print("heading : {}Pi".format(yaw/pi))
