...
/* FreeRTOS NO_SYS=0: FromISR API는 configMAX_API_CALL_INTERRUPT_PRIORITY(=31) 이하에서만 허용 */
#define ISR_PRIORITY_CAN_RX         30      /* CAN RX uses FreeRTOS FromISR APIs; keep <= 31 */
